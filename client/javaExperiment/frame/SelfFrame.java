...
public class SelfFrame extends BaseFrame {
	...
	private void modButtonActionPerformed(ActionEvent evt) {
		String username = CurrentsUser.getName();
		...
		if (oldpwd == null || newpwd.equals("")) {
			JOptionPane.showMessageDialog(this, "原密码不能为空！！！");
		}
		if(!oldpwd.equals(CurrentsUser.getPassword())) {
			JOptionPane.showMessageDialog(this, "原密码错误！！！");
		}
		else if (oldpwd.equals(CurrentsUser.getPassword())) {
			if (newpwd == null || newpwd.equals("")) {
				...
				try {
					if (JOptionPane.showConfirmDialog(this,
						...
						//UserDataProcessing.update(CurrentsUser.getName(), newpwd,CurrentsUser.getRole());
						userService.changeInfo(CurrentsUser.getName(), newpwd,CurrentsUser.getRole());
						JOptionPane.showMessageDialog(this, "密码修改成功！！！");
						CurrentsUser.setPassword(newpwd);
					}
				}
				catch (Exception ex) {
	...
	private void showUserInfoToPanel(){
		nametextField.setText(CurrentsUser.getName());
		roletextField.setText(CurrentsUser.getRole());		
	}
